...
expression
    ...
    | '(' referenceType additionalBound* ')' expression # castExpression // | '(' referenceType additionalBound* ')' lambdaExpression
    ...
    | expression '&&' expression # conditionalAndEexpression
    | expression '||' expression # conditionalOrEexpression
    | expression '?' expression ':' expression # conditionalEexpression
    | expression assignmentOperator expression # assignmentEexpression
    ;
